...
Inicializar <- function() {
  ...
  source(paste0(texto1,"Modelo_2-surplus_based_ownership.R"))
  source(paste0(texto1,"Modelo_2-surplus_based_ownership_v2.R"))
  source(paste0(texto1,"Modelo_2-bill_sharing.R"))
